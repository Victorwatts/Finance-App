<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RentalAmount.aspx.cs" Inherits="PROG6212_POE.Forms.RentalAmount" %>
...
<body>
	  <div class="topnav">
		...
		<a class="active">Monthly Rent</a>
		  </div>
    <form id="form1" runat="server">
        <h2>Monthly Rental Amount</h2>
		
		<p>
			<label for="Monthly Rent" class="floatLabel">Monthly Rent</label>
			<asp:TextBox id="txtRentAmount" name="RentAmount" type="Number" step="0.01" min="0" runat="server" TextMode="Number"/>
		</p>
